...
// // Función para crear carta de producto 
// export function createCardProduct(productoData) {
//     console.log(productoData);
//     // Obtener el elemento del DOM por el id "app"
...
//     content += `
//         <div class="card">
//             <div class="card-img">${productoData.userPoster}</div>
//             <div class="card-info">
//                 <p class="text-title">${productoData.postName} </p>
//                 <p class="text-body">${productoData.description}</p>
//             </div>
//             <div class="card-footer">
//                 <span class="text-title">499€</span>
//                 <div class="card-button">
...
//     // Insertar el contenido en el elemento del DOM
