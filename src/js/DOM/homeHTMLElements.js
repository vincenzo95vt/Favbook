...
export function addCommentField(value){
    const postElem = document.getElementById(`postCard-${value}`)
    postElem.innerHTML = `
    <form class="sendComments" id="comment-form">
